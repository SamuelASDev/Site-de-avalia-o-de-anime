...
<div id="tudo">
  ...
  <div id="conteutoglobal">
    ...
    <div id="perfil-container">
      <div id="perfil-foto">
          <img 
              src="{{ asset(str_replace('public/', 'storage/', auth()->user()->imagem_perfil)) }}" 
              class="img-perfil" 
              alt="Foto de perfil">
      </div>
      <div id="perfil-info">
          ...
          <form action="{{ route('perfil.uploadImagem') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="file" name="imagem_perfil" required>
              <button type="submit" class="btn-primary">Alterar Imagem de Perfil</button>
          </form>
      </div>
  </div>
